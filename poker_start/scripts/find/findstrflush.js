function findStraightFlushCard() {
  ...
  var straightFlushArr = checkHandForStraightFlush(cardArr);
  ...
  if (cardsPlayed == 3) {
    ...
    var fourthFound = findFourthCardInStraightFlush();
    if (fourthFound) {
  ...
  var partialArr = findPartialStraightFlush(cardArr);
...
function findPartialStraightFlush(cardArr) {
  ...
  outer: for (var i = 0; i < cardArr.length; i++) {
    var card1 = cardArr[i];
    //addLog("card1" + printCard(card1));
    firstInner: for (var j = i; j < cardArr.length; j++) {
      var card2 = cardArr[j];
      //addLog("card2" + printCard(card2));
      if (card1.suit == card2.suit) {
        if (card1.value == card2.value - 1) {
          for (var k = j; k < cardArr.length; k++) {
            var card3 = cardArr[k];
            ...
            if (card2.suit == card3.suit) {
              if (card2.value == card3.value - 1) {
                ...
                var isValid = isPartialArrayValidAttemptAtStraightFlush(card1.value, card2.value, card3.value, card1.suit);
                if (isValid == false) {
                  break firstInner;
                }

                for (var l = k; l < cardArr.length; l++) {
                  var card4 = cardArr[l];
...
function checkHandForBetterStraightFlush(cardArr) {
  var prev = getStraightFlushScore();
  var curr = 0;
...
function findFourthCardInStraightFlush() {
  ...
  if (strFlushSlotCard1.suit == strFlushSlotCard2.suit &&
    ...
    if (strFlushSlotCard1.value == strFlushSlotCard2.value - 1 &&
      ...
      //check cards are straight
      var suit = strFlushSlotCard1.suit;
      var lowValue = strFlushSlotCard1.value - 1;
      var highValue = strFlushSlotCard3.value + 1;
...
function findFifthCardInStraightFlush() {
  ...
  if (strFlushSlotCard1.suit == strFlushSlotCard2.suit &&
    ...
    if (strFlushSlotCard1.value == strFlushSlotCard2.value - 1 &&
      ...
      var suit = strFlushSlotCard1.suit;
      var lowValue = strFlushSlotCard1.value - 1;
      var highValue = strFlushSlotCard4.value + 1;

      var playerCards = getPlayerCards();
      for (var i = 0; i < playerCards.length; i++) {
        var fifthCard = playerCards[i];
